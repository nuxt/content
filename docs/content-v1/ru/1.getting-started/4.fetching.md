...
Для фильтрации в объектах и массивах вам нужно включить nestedProperties, взгляните на [конфигурацию](/ru/v1/getting-started/configuration#nestedproperties).
...
Поля, по которым вы хотите искать, должны быть определены в опциях, чтобы их можно было проиндексировать, взгляните на [конфигурацию](/ru/v1/getting-started/configuration#fulltextsearchfields).
...
Посмотрите [пример](/ru/v1/community/snippets#поиск) о том, как реализовать поиск в вашем приложении
...
::alert{type="info"}
Посмотрите [пример](/ru/v1/community/snippets#пагинация) как реализовать ссылки вперед и назад в вашем приложении
::
...
> Вы можете проверить, как использовать [API контента](/ru/v1/getting-started/advanced#api) в разработке.
