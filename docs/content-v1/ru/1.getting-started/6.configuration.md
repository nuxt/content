...
Прежде чем погрузиться в отдельные атрибуты, взгляните на [Настройки по умолчанию](#настройки-по-умолчанию).
...
Вы можете указать абсолютный или относительный путь, будет обработано Nuxt [srcDir](https://v2.nuxt.com/docs/configuration-glossary/configuration-srcdir).
...
Поля, которые нужно проиндексировать, для возможности поиска по ним, почитайте подробнее об этом [здесь](/ru/v1/getting-started/fetching#searchполе-значение).
...
> Вы можете посмотреть плагины для [remark](https://github.com/remarkjs/remark/blob/main/doc/plugins.md#list-of-plugins).
...
> Вы можете посмотреть плагины для [rehype](https://github.com/rehypejs/rehype/blob/main/doc/plugins.md#list-of-plugins).
