...
Vous pouvez en apprendre plus à propos de cet endpoint dans [lib/middleware.js](https://github.com/nuxt/content/blob/master/lib/middleware.js).<!--TODO: fix link-->
