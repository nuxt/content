...
> Consulter la [documentation de la table des matières](/fr/v1/getting-started/writing#table-des-matières).
...
Vous pouvez obtenir le même résultat en utilisant [Shiki Twoslash](https://github.com/microsoft/TypeScript-Website/tree/v2/packages/shiki-twoslash).<!--TODO: fix link--> Ce package est également celui qui alimente la documentation officielle de TypeScript.
