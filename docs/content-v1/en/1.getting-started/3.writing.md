...
Say we have a Vue component called [ExampleMultiselect.vue](https://github.com/nuxt/content/blob/master/docs/components/global/examples/ExampleMultiselect.vue):<!--TODO: fix link-->
...
[dynamic content](https://vuejs.org/v2/guide/syntax.html) nor use<!--TODO: maybe fix link-->
[slot props](https://vuejs.org/v2/guide/components-slots.html#Scoped-Slots). I.e.,<!--TODO: maybe fix link-->
**this wont work**:
