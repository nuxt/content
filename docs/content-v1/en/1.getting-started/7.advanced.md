...
- `database`
  - Type: `object`
  - Properties:
    - See [type definition](https://github.com/nuxt/content/blob/master/packages/content/types/database.d.ts)<!--TODO: fix link-->
...
This documentation uses it actually. You can learn more by looking at [plugins/init.js](https://github.com/nuxt/content/blob/master/docs/plugins/init.js).<!--TODO: fix link-->
...
> You can learn more about that endpoint in [lib/middleware.js](https://github.com/nuxt/content/blob/main/packages/content/lib/middleware.js).<!--TODO: fix link-->
