...
You can achieve the same result by using [Shiki Twoslash](https://github.com/microsoft/TypeScript-Website/tree/v2/packages/shiki-twoslash).<!--TODO: fix link--> This package is also the one that powers the Official TypeScript Documentation.
