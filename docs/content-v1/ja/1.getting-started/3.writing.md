...
[ExampleMultiselect.vue](https://github.com/nuxt/content/blob/master/docs/components/examples/global/ExampleMultiselect.vue)というVueコンポーネントがあるとします:<!--TODO: fix link-->
