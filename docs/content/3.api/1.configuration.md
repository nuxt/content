...
Nuxt Content uses [Shiki](https://github.com/shikijs/shiki) to provide syntax highlighting for [`ProseCode`](/api/prose#prosecode) and [`ProseCodeInline`](/api/prose#prosecodeinline).
