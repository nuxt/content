...
When using `queryContent()`{lang="ts"}, you will retrieve a [`QueryBuilder`](https://github.com/nuxt/content/blob/main/src/runtime/types.d.ts#L128) instance.<!--TODO: fix link! maybe https://github.com/nuxt/content/blob/main/src/runtime/types/index.d.ts#L429-->

Once you use one of the fetching methods (`find()`{lang="ts"}, `findOne()`{lang="ts"}, `findSurround()`{lang="ts"}), you will retrieve an object of type [`ParsedContent`](https://github.com/nuxt/content/blob/main/src/runtime/types.d.ts#L128).<!--TODO: fix link! maybe https://github.com/nuxt/content/blob/main/src/runtime/types/index.d.ts#L51-->
