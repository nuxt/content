---
title: Setup
description: Install and configure the self-hosted Nuxt Studio module to enable
  visual content editing directly on your production website.
navigation:
  title: Setup
seo:
  title: Nuxt Studio Setup Guide
  description: Learn how to install and configure the Nuxt Studio module for your
    Nuxt Content website. Edit content in production with GitHub authentication.
visual content editing directly on your production website:
  " navigation":
    title: Setup
    icon: i-lucide-settings
Nuxt Content website:
  " Edit content in production with GitHub authentication":
    - null
---

::warning
This documentation only refers to the new open source Studio module. Click here if you want to access the old standalone platform documentation.
::
