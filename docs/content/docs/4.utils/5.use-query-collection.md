...
- `.all()` — returns `AsyncData<R[] | undefined, NuxtError | undefined>`
- `.first()` — returns `AsyncData<R | null | undefined, NuxtError | undefined>`
- `.count(field?, distinct?)` — returns `AsyncData<number | undefined, NuxtError | undefined>`
